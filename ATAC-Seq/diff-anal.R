...
Condition <- substr(SampleID, 4, 4) %>% unlist()    # Reverse
# 12
...
Replicate <- substr(SampleID, 5, 5)%>% unlist()     # Reverse
# %>% as.numeric()
# 3
...
# Merged peaks generated by Andrea's R code above
...
# Straight from MACS
# Peaks <- "7-macs-peaklets/ATAC-NCA-macs.peaklets_peaks.narrowPeak"
